      ...
      <div class="col-sm-10 mt-3">
        ...
        <div class="card mb-3">
          <div class="row g-0 d-flex flex-wrap align-items-center">
            ...
            which they are enrolled.</p>
                ...
                <p class="card-text"><a class="btn btn-outline-secondary" href="/appeals/grade-appeals">Start A Grade Appeal <i class="bi bi-arrow-right-circle ms-2"></i></a></p>
              </div>
            </div>
          </div>
        </div><!--end card-->
        ...
        <div class="card mb-3">
          <div class="row g-0 d-flex flex-wrap align-items-center">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><a class="btn btn-outline-secondary" href="">Choose SAP Appeal Type <i class="bi bi-arrow-right-circle ms-2"></i></a></p>
              </div>
            </div>
          </div>
        </div><!--end card-->
        ...
        <div class="card-body">
            ...
            drop deadline.
                ...
                <p class="card-text"><a class="btn btn-outline-secondary" href="">Start A Tuition Appeal <i class="bi bi-arrow-right-circle ms-2"></i></a></p>
              </div>
            </div>
          </div>
        </div><!--end card-->
        ...
        <div class="card-body">
            ...
            the available facts.</p>
                ...
                <p class="card-text"><a class="btn btn-outline-secondary" href="">Start A Provost Appeal <i class="bi bi-arrow-right-circle ms-2"></i></a></p>
              </div>
            </div>
          </div>
        </div><!--end card-->
        ...
        <div class="card-body">
            ...
            satisfactorily.</p>
                ...
                <p class="card-text"><a class="btn btn-outline-secondary" href="">Start Retroactive Withdrawal <i class="bi bi-arrow-right-circle ms-2"></i></a></p>
              </div>
            </div>
          </div>
        </div><!--end card-->
