<template>
  <Navbar />
  <!--<PageBanner title="Grade Appeals" />-->
  <div class="grade-appeal section container">
    <div class="row pt-5">
      <div class="clearfix">
    ...
    <a class="btn btn-info my-3" href="#" target="_blank">Grade Appeal Form <span class="bi bi-arrow-right"></span></a>
        </div><!--end card body -->
